...
db.eventos.insertMany([
  {
    ...
    cancelado: false,
    fechaInicio: ISODate("2025-06-03T09:00:00Z"),
    nombreEvento: "Seminario Transformación Digital",
    reservas: [],
    _class: "reservas.dominio.Evento"
  },
  {
    _id: "2caa6ccb-5d80-44a7-8227-4b72700f7c91",
    plazasDisponibles: 80,
    cancelado: false,
    fechaInicio: ISODate("2025-06-10T14:00:00Z"),
    nombreEvento: "Concierto Primaveral",
    reservas: [],
    _class: "reservas.dominio.Evento"
  },
  {
    _id: "7c273e2a-78cc-4986-8d04-34e4a77261ef",
    plazasDisponibles: 100,
    cancelado: false,
    fechaInicio: ISODate("2025-06-04T09:00:00Z"),
    nombreEvento: "Hackathon Innovación 2025",
    reservas: [],
    _class: "reservas.dominio.Evento"
  },
  {
    _id: "ba3c74c8-5b3d-4e1a-9dc8-d0f4ea1f54c3",
    plazasDisponibles: 60,
    cancelado: false,
    fechaInicio: ISODate("2025-06-18T10:00:00Z"),
    nombreEvento: "Taller de Prototipado 3D",
    reservas: [],
    _class: "reservas.dominio.Evento"
  },
  {
    _id: "8e1a056d-0519-4762-bc28-0699e0238571",
    plazasDisponibles: 25,
    cancelado: false,
    fechaInicio: ISODate("2025-06-05T10:00:00Z"),
    nombreEvento: "Taller Micro‑relatos",
    reservas: [],
    _class: "reservas.dominio.Evento"
  },
  {
    _id: "4323dcea-6b28-46b7-a563-29de89abde26",
    plazasDisponibles: 30,
    cancelado: false,
    fechaInicio: ISODate("2025-06-22T19:00:00Z"),
    nombreEvento: "Cine Universitario Nocturno",
    reservas: [],
    _class: "reservas.dominio.Evento"
  },
  {
    _id: "4f829e16-0e23-46fb-8ff1-42dc0e3bd7fa",
    plazasDisponibles: 64,
    cancelado: false,
    fechaInicio: ISODate("2025-06-06T09:00:00Z"),
    nombreEvento: "Torneo Blitz Universitario",
    reservas: [],
    _class: "reservas.dominio.Evento"
  },
  {
    _id: "5b9d5eae-1a21-4b07-b758-7da0627153f6",
    plazasDisponibles: 70,
    cancelado: false,
    fechaInicio: ISODate("2025-06-24T20:00:00Z"),
    nombreEvento: "Noche de Stand‑Up",
    reservas: [],
    _class: "reservas.dominio.Evento"
  },
  {
    _id: "a7b6c9b8-7527-4c90-9c30-6e63c65eac3e",
    plazasDisponibles: 90,
    cancelado: false,
    fechaInicio: ISODate("2025-06-07T11:00:00Z"),
    nombreEvento: "Foro Ética IA",
    reservas: [],
    _class: "reservas.dominio.Evento"
  },
  {
    _id: "56e0efac-1c6e-4b4d-96a8-74afadc3e0cc",
    plazasDisponibles: 85,
    cancelado: false,
    fechaInicio: ISODate("2025-06-29T18:00:00Z"),
    nombreEvento: "Concierto de Cámara",
    reservas: [],
    _class: "reservas.dominio.Evento"
  },
  {
    _id: "e8eaf4b1-27c0-4aea-b3e6-6e3bc5d9d04f",
    plazasDisponibles: 20,
    cancelado: false,
    fechaInicio: ISODate("2025-06-08T19:00:00Z"),
    nombreEvento: "Yoga Sunset",
    reservas: [],
    _class: "reservas.dominio.Evento"
  },
  {
    _id: "3df0ab09-8d10-4f3c-af89-083a8a265bd5",
    plazasDisponibles: 18,
    cancelado: false,
    fechaInicio: ISODate("2025-06-17T10:00:00Z"),
    nombreEvento: "Fotografía con Smartphone",
    reservas: [],
    _class: "reservas.dominio.Evento"
  },
  {
    _id: "c46b4f96-b76d-4522-8ac5-bb8a0d45d076",
    plazasDisponibles: 45,
    cancelado: false,
    fechaInicio: ISODate("2025-06-09T09:00:00Z"),
    nombreEvento: "Bootcamp Scrum",
    reservas: [],
    _class: "reservas.dominio.Evento"
  },
  {
    _id: "ad3ac6e7-ccd2-415e-a734-1e7c17f49a2e",
    plazasDisponibles: 50,
    cancelado: false,
    fechaInicio: ISODate("2025-06-27T10:00:00Z"),
    nombreEvento: "Actualización Docente 2025",
    reservas: [],
    _class: "reservas.dominio.Evento"
  },
  {
    _id: "cdd20c26-cfb1-4f87-8c89-eaee153b1e60",
    plazasDisponibles: 48,
    cancelado: false,
    fechaInicio: ISODate("2025-06-11T08:00:00Z"),
    nombreEvento: "Vóley Interfacultades",
    reservas: [],
    _class: "reservas.dominio.Evento"
  },
  {
    _id: "f4626893-d962-46c9-9e4e-91302aab1d37",
    plazasDisponibles: 50,
    cancelado: false,
    fechaInicio: ISODate("2025-06-26T17:00:00Z"),
    nombreEvento: "Rock Universitario",
    reservas: [],
    _class: "reservas.dominio.Evento"
  },
  {
    _id: "0d5aa27c-9d46-4e32-a611-f480a1b7c993",
    plazasDisponibles: 60,
    cancelado: false,
    fechaInicio: ISODate("2025-06-12T10:00:00Z"),
    nombreEvento: "Jornada Bienestar",
    reservas: [],
    _class: "reservas.dominio.Evento"
  },
  {
    _id: "fa04b485-02a5-4ddb-a93c-0bb1e0b9ea04",
    plazasDisponibles: 70,
    cancelado: false,
    fechaInicio: ISODate("2025-06-28T09:00:00Z"),
    nombreEvento: "Expo Naturaleza",
    reservas: [],
    _class: "reservas.dominio.Evento"
  },
  {
    _id: "3a20c2fd-6e9b-4f0d-aef5-478e1e025246",
    plazasDisponibles: 100,
    cancelado: false,
    fechaInicio: ISODate("2025-06-13T09:00:00Z"),
    nombreEvento: "Conferencia Big Data",
    reservas: [],
    _class: "reservas.dominio.Evento"
  },
  {
    _id: "8a61a382-4992-4b2a-8981-d6d2a1f19725",
    plazasDisponibles: 90,
    cancelado: false,
    fechaInicio: ISODate("2025-06-23T15:00:00Z"),
    nombreEvento: "Geek Trivia Cup",
    reservas: [],
    _class: "reservas.dominio.Evento"
  },
  {
    _id: "188eaa3b-8d98-4eaf-9dc2-8a0bae4c3076",
    plazasDisponibles: 120,
    cancelado: false,
    fechaInicio: ISODate("2025-06-14T11:00:00Z"),
    nombreEvento: "Feria Gastronómica",
    reservas: [],
    _class: "reservas.dominio.Evento"
  },
  {
    _id: "b62e83db-3610-4e0c-a07e-e2e6e7116e5e",
    plazasDisponibles: 110,
    cancelado: false,
    fechaInicio: ISODate("2025-06-25T09:00:00Z"),
    nombreEvento: "Workshop Impresión 3D",
    reservas: [],
    _class: "reservas.dominio.Evento"
  },
  {
    _id: "1ba5e7e2-4ff2-40d2-b7e3-9982a8e9374c",
    plazasDisponibles: 75,
    cancelado: false,
    fechaInicio: ISODate("2025-06-15T10:00:00Z"),
    nombreEvento: "Foro Trabajo Remoto",
    reservas: [],
    _class: "reservas.dominio.Evento"
  },
  {
    _id: "83823d6e-b6fd-4d09-b8e4-11b0cf50dab4",
    plazasDisponibles: 80,
    cancelado: false,
    fechaInicio: ISODate("2025-06-27T16:00:00Z"),
    nombreEvento: "Retro Gaming Cup",
    reservas: [],
    _class: "reservas.dominio.Evento"
  },
  {
    _id: "5c7bd6df-2660-48f4-957b-7e44f246ad9f",
    plazasDisponibles: 90,
    cancelado: false,
    fechaInicio: ISODate("2025-06-16T09:00:00Z"),
    nombreEvento: "Data Journalism 2025",
    reservas: [],
    _class: "reservas.dominio.Evento"
  },
  {
    _id: "23ff86f5-fba6-4b4a-9589-afdbb4ba9a36",
    plazasDisponibles: 110,
    cancelado: false,
    fechaInicio: ISODate("2025-06-30T11:00:00Z"),
    nombreEvento: "Arte Digital Hoy",
    reservas: [],
    _class: "reservas.dominio.Evento"
  },
  ...
  {
    _id: "9bc5f363-8801-4e7e-99f4-cf5e4c4c1b63",
    plazasDisponibles: 90,
    cancelado: true,
    fechaInicio: null,
    nombreEvento: "Simposio Investigación 2025",
    reservas: [],
    _class: "reservas.dominio.Evento"
  },
  {
    _id: "d6e1b7cb-23ed-4fd2-8fb7-b8e5d1b7a4f9",
    plazasDisponibles: 85,
    cancelado: true,
    fechaInicio: null,
    nombreEvento: "Feria del Libro Infantil",
    reservas: [],
    _class: "reservas.dominio.Evento"
  },
  {
    _id: "0894d6a0-ed88-4716-82e0-c370b392cc11",
    plazasDisponibles: 104,
    cancelado: true,
    fechaInicio: null,
    nombreEvento: "Torneo Atletismo Cancelado",
    reservas: [],
    _class: "reservas.dominio.Evento"
  },
  {
    _id: "4e2a71c4-af97-44b6-9803-48c0026bfe76",
    plazasDisponibles: 80,
    cancelado: true,
    fechaInicio: null,
    nombreEvento: "Festival Rock Cancelado",
    reservas: [],
    _class: "reservas.dominio.Evento"
  }
]);
