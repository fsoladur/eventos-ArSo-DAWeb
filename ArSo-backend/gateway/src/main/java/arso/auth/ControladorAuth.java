...
public class ControladorAuth {
	...
	@PostMapping("/login")
	public ResponseEntity<AutorizationResponseDto> login(@RequestParam String username, @RequestParam String password, HttpServletResponse response) {
		...
		if (claims != null) {
			...
			AutorizationResponseDto responseDto 
				= new AutorizationResponseDto(usuario.getId(), usuario.getUsername(), usuario.getRoles(), token);
