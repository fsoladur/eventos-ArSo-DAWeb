          ...
          <Card className="shadow-none border-0">
            <Card.Body>
              <Card.Title className="text-primary fw-bold">
                {evento.nombre}
                <span className={`badge bg-${getBadgeColor(evento.categoria)} ms-xl-5 ms-2 fs-6 align-middle`}>
                  {evento.categoria}
                </span>
              </Card.Title>
              <Card.Text>
                <strong>Descripción:</strong> {evento.descripcion || "No disponible"}
              </Card.Text>
              <Card.Text>
              ...
              {!evento.cancelado && (
                <>
                  ...
                  <Card.Text>
                    <strong>Fecha de inicio:</strong> {evento.ocupacion.fechaInicio}
                  </Card.Text>
                  <Card.Text>
                    <strong>Fecha de fin:</strong> {evento.ocupacion.fechaFin}
                  </Card.Text>
                  <Card.Text>
                    <strong>Lugar:</strong> {evento.ocupacion.nombreEspacioFisico}
                  </Card.Text>
                  <Card.Text>
                    <strong>Dirección:</strong> {evento.ocupacion.direccionEspacioFisico}
                  </Card.Text>
                </>
              )}
        ...
        {reservas.length === 0 && (
          <Col md={6}>
            <Card className="shadow-sm">
              <Card.Body>
                <Card.Title className="text-primary fw-bold">No hay reservas</Card.Title>
